            ...
            <div class="main-wrap">
                <div class="swiper-container banner-swiper">
                    <ul class="swiper-wrapper">
                        <li class="swiper-slide"><img src="../../assets/pic.png"></li>
                        <li class="swiper-slide"><img src="../../assets/pic.png"></li>
                        <li class="swiper-slide"><img src="../../assets/pic.png"></li>
                        <li class="swiper-slide"><img src="../../assets/pic.png"></li>
                    </ul>
                ...
                <div class="icon-lists">
                    <div class="icon-lists-top">
                        <dl>
                            <dt style="background: #47D265"><img src="../../assets/3_r1_c2.png"></dt>
                            <dd> 家乡味道</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FF7902"><img src="../../assets/3_r1_c5.png"></dt>
                            <dd>进口食品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BAAFF"><img src="../../assets/3_r1_c10.png"></dt>
                            <dd>牛奶乳品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFB447"><img src="../../assets/3_r1_c13.png"></dt>
                            <dd>茶果冲引</dd>
                        </dl>
                    </div>
                    <div class="icon-lists-bot">
                        <dl>
                            <dt style="background: #FF655B"><img src="../../assets/3_r3_c1.png"></dt>
                            <dd>休闲零食</dd>
                        </dl>
                        <dl>
                            <dt style="background: #67CCFF"><img src="../../assets/3_r3_c6.png"></dt>
                            <dd>米面粮油</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFD33C"><img src="../../assets/3_r3_c9.png"></dt>
                            <dd>调味调料</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BDCC8"><img src="../../assets/3_r3_c14.png"></dt>
                            <dd>酒水新料</dd>
                        </dl>
                    </div>
                </div>
                        ...
                        <div class="swiper-container top-swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    绿色无染，害绿色无污染，无公害绿色无污染，无公害绿色无污染，无公害
                                </div>
                                <div class="swiper-slide">
                                    绿色无染，害绿色无污染，无公害绿色无污染，无公害绿色无污染，无公害
                                </div>
                ...
                <div class="foodie">
                    <div class="foodie-left"><img src="../../assets/home1.png"></div>
                    <div class="foodie-right">
                        <div class="foodie-right-top">

                            <img src="../../assets/gaodian.png">
                        </div>
                        <div class="foodie-right-bottom">

                            <img src="../../assets/ruwei.png">
                        </div>
                    </div>
                </div>
...
import swipers from '../../css/swiper.min.js';
export default {
    name: 'home',
    data() {
        return {
